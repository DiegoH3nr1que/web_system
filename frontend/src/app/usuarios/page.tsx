...
export default function UserPage() {
  ...
  const handleEditUser = async (userId: number, updatedData: { username: string; role: string }) => {
    try {
        ...
        <div className="flex-1 flex">
          ...
          <main className="flex-1 flex flex-col p-6 bg-background">
            <header className="text-left p-4 rounded-md mb-6 flex justify-between">
              <h1 className="text-4xl font-bold uppercase text-foreground">Usuários</h1>
              <RealTimeClock />
            </header>
            ...
            <div className="flex-1">
              <div className="container mx-auto p-4 bg-background rounded-lg">
                <div className="flex justify-between items-center mb-4">
                  <h1 className="text-2xl font-bold text-foreground">Lista de usuários cadastrados</h1>
                  <UserDialog
                      ...
                      actions={(item) => (
                        <div className="flex space-x-2">
                          <UserDialog
                            ...
                            user={{ username: item.username, role: item.role }}
